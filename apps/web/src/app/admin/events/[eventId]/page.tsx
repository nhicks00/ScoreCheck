...
import { EventDashboard, type DashboardCourt } from "@/components/EventDashboard";
...
export default async function EventPage({
  ...
  const [eventResult, sourceResult, courts, matchResult, queueResult, heartbeatResult, errorResult] = await Promise.all([
    ...
    loadAdminCourtsWithCurrentScores<DashboardCourt>(eventId, db),
    ...
    <main className="shell">
      <div className="container stack">
        ...
        <EventDashboard
          ...
          initialTab={tab === "queues" ? "queues" : undefined}
        />
      </div>
    </main>
  );
