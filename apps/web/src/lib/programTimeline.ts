...
export const PROGRAM_HLS_STARTUP_BUFFER_SECONDS = 10;
export const PROGRAM_HLS_BUFFER_LENGTH_SECONDS = 18;
export const PROGRAM_HLS_BACK_BUFFER_SECONDS = 4;
export const PROGRAM_HLS_MAX_BUFFER_BYTES = 32_000_000;
