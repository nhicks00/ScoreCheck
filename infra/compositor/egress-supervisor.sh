...
# Keep the lock descriptor scoped to one reconciliation. Otherwise watch mode
# retains the lock while sleeping and starves deliberate start/stop operations.
reconcile_once() (
