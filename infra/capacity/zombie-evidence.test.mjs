...
test("rejects malformed, unsafe, or over-broad event data", () => {
  ...
  for (const classification of ["healthcheck.program-warmer", "healthcheck.program-warmer.runtime", "workload.egress-xkbcomp", "workload.mediamtx-ffmpeg", "workload.mediamtx-progress-parser", "workload.mediamtx-runner", "workload.mediamtx-sleep", "workload.monitor-content-probe", "workload.monitor-content-analyzer"]) {
