...
const CLASSIFICATION = /^(?:unclassified|observer\.capacity-ssh|healthcheck\.(?:caddy|monitor-agent|egress|mediamtx|program-warmer|redis)(?:\.runtime)?|workload\.(?:egress-(?:chrome|handler|pactl|gst-plugin-scan|xkbcomp|xvfb-shell)|mediamtx-(?:ffmpeg|progress-parser|runner|sleep)|monitor-content-(?:probe|analyzer)))$/;
