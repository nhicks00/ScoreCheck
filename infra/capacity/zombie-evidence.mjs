...
const CLASSIFICATION = /^(?:unclassified|observer\.capacity-ssh|healthcheck\.(?:caddy|monitor-agent|egress|mediamtx|redis)(?:\.runtime)?|workload\.(?:egress-(?:chrome|handler|pactl|gst-plugin-scan|xkbcomp|xvfb-shell)|mediamtx-(?:ffmpeg|sleep)|monitor-content-(?:probe|analyzer)))$/;
