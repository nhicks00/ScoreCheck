...
test("runs the exact build, workload, provider cleanup, evidence, and Droplet teardown order", () => {
  ...
  assert.deepEqual(commands, [
    ...
    "rehearsal:start", "rehearsal:soak", "rehearsal:stop", "rehearsal:cleanup", "rehearsal:seal",
    "lifecycle:close", "lifecycle:evidence", "lifecycle:destroy"
  ]);
...
test("failed live gate completes provider cleanup and evidence before infrastructure destroy", () => {
  ...
  assert.deepEqual(commands, ["rehearsal:stop", "rehearsal:cleanup", "rehearsal:seal", "lifecycle:close", "lifecycle:evidence", "lifecycle:destroy"]);
});
