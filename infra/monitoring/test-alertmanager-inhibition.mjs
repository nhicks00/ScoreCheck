...
const alerts = [
  ...
  alert("agent-analyzer-target", "ScoreCheckCameraContentAnalyzerUnavailable", { agent: "compositor-a", court: "2" }),
  ...
  alert("analyzer-source", "ScoreCheckCameraContentAnalyzerUnavailable", { agent: "compositor-h", court: "8" }),
  alert("analyzer-visual-target", "ScoreCheckCameraVisualFreeze", { agent: "compositor-h", court: "8" }),
  alert("analyzer-audio-target", "ScoreCheckCameraAudioSilent", { agent: "compositor-h", court: "8" }),
  alert("analyzer-peer", "ScoreCheckCameraVisualFreeze", { agent: "compositor-g", court: "7" }),
...
const expected = new Map([
  ...
  ["agent-analyzer-target", "suppressed"],
  ["agent-peer", "active"],
  ...
  ["analyzer-source", "active"],
  ["analyzer-visual-target", "suppressed"],
  ["analyzer-audio-target", "suppressed"],
  ["analyzer-peer", "active"],
  ["score-source", "active"],
