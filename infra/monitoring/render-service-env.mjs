...
const optionalNames = [
  ...
  "MONITOR_UNIFI_CAMERA_CLIENTS_JSON",
...
values.MONITOR_LOCAL_OUTBOX_PATH = process.env.MONITOR_LOCAL_OUTBOX_PATH?.trim() || "/var/lib/scorecheck-monitoring/incident-outbox.json";
...
values.MONITOR_PEPLINK_REQUIRED = "true";
values.MONITOR_PEPLINK_POLL_INTERVAL_MS = process.env.MONITOR_PEPLINK_POLL_INTERVAL_MS?.trim() || "30000";
values.MONITOR_UNIFI_POLL_INTERVAL_MS = process.env.MONITOR_UNIFI_POLL_INTERVAL_MS?.trim() || "30000";
values.MONITOR_NETWORK_SWITCH_POLL_INTERVAL_MS = process.env.MONITOR_NETWORK_SWITCH_POLL_INTERVAL_MS?.trim() || "30000";
