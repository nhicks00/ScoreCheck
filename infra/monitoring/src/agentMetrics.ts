...
export class AgentMetrics {
  ...
  private readonly transportPacketsLost = new Gauge({ name: "scorecheck_media_transport_packets_lost_total", help: "Source transport cumulative packets detected as missing or reordered.", labelNames: ["agent", "court", "branch", "protocol"], registers: [this.registry] });
  private readonly transportPacketsRetransmitted = new Gauge({ name: "scorecheck_media_transport_packets_retransmitted_total", help: "Source transport cumulative retransmitted packets received.", labelNames: ["agent", "court", "branch", "protocol"], registers: [this.registry] });
  private readonly transportPacketsDropped = new Gauge({ name: "scorecheck_media_transport_packets_dropped_total", help: "Source transport cumulative packets discarded by the receiver, including belated or duplicate packets.", labelNames: ["agent", "court", "branch", "protocol"], registers: [this.registry] });
