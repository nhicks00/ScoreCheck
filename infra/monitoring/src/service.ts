...
const routerSpeedFusionTransmit = new Gauge({ name: "scorecheck_router_speedfusion_link_transmit_bits_per_second", help: "Current reset-safe SpeedFusion tunnel transmit rate by WAN link.", labelNames: ["wan"], registers: [registry] });
const routerSpeedFusionLoss = new Gauge({ name: "scorecheck_router_speedfusion_link_transmit_packet_loss_percent", help: "Current reset-safe SpeedFusion tunnel transmit packet-loss percentage by WAN link.", labelNames: ["wan"], registers: [registry] });
const routerSpeedFusionFec = new Gauge({ name: "scorecheck_router_speedfusion_link_fec_percent", help: "Current reset-safe SpeedFusion tunnel forward-error-correction overhead percentage by WAN link.", labelNames: ["wan"], registers: [registry] });
